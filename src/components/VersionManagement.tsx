        ...
        <div className="hidden lg:block flex-1 sticky top-24">
          <AnimatePresence mode="wait">
            {selectedVersion ? (
              ...
              <div className={cn(
                "h-full flex items-center justify-center border-2 border-dashed rounded-[40px] opacity-30 min-h-[400px]",
                      ...
                      <div key={user.uid} className="flex items-center justify-between gap-3 group">
                        <div className="flex items-center gap-3 min-w-0">
                          <div className={cn(
                            ...
                            hasRead ? "ring-emerald-500/30" : (isDarkMode ? "ring-slate-800/50 opacity-40" : "ring-slate-100 opacity-40"),
                        ...
                        <div className={cn(
                          ...
                          hasRead ? "bg-emerald-500 shadow-lg shadow-emerald-500/50" : (isDarkMode ? "bg-slate-800" : "bg-slate-200")
                        )} />
                      </div>
                    );
                  })}
